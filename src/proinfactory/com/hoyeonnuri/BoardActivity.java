...
public class BoardActivity extends SlidingDrawerActivity {

    public static final String INTENT_KEY = "BOARDKEY";
    ...
    public void onCreate(Bundle inState) {
        ...
        viewPagerAdapter = new BoardViewPagerAdapter(getSupportFragmentManager(), this);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.drawer_devinfo:
                    mViewPager.setCurrentItem(ViewPagerAdapter.FRAGMENT_BOARD_DEVINFO);
                    break;
                case R.id.drawer_board_notice:
                    mViewPager.setCurrentItem(ViewPagerAdapter.FRAGMENT_BOARD_NOTICE);
                    break;
                case R.id.drawer_board_free:
                    mViewPager.setCurrentItem(ViewPagerAdapter.FRAGMENT_BOARD_FREE);
                    break;
                case R.id.drawer_board_repair:
                    mViewPager.setCurrentItem(ViewPagerAdapter.FRAGMENT_BOARD_REPAIR);
                    break;
                case R.id.drawer_board_qna:
                    mViewPager.setCurrentItem(ViewPagerAdapter.FRAGMENT_BOARD_QNA);
                    break;
                case R.id.drawer_restaurant_notice:
                    intent = new Intent(BoardActivity.this, RestaurantActivity.class);
                ...
                case R.id.drawer_info_bus:
                    intent = new Intent(BoardActivity.this, InfoActivity.class);
                ...
                case R.id.drawer_delivery:
                    intent = new Intent(BoardActivity.this, DeliveryActivity.class);
                    startActivity(intent);
                    finish();
                    break;
            }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    ...
                    break;
                case 1:
                    Toast.makeText(BoardActivity.this, "로그인 실패", Toast.LENGTH_LONG).show();
                    isLoginIng = false;
                    break;
                case 2:
                    Toast.makeText(BoardActivity.this, "로그아웃", Toast.LENGTH_LONG).show();
                    isLoginIng = false;
                    break;
                case 3:
